...
<head>
  <title>Hoist Repair Services | Get back on the job as soon as possible</title>
  <meta charset="utf-8">
  <meta name="description" content="On-call, scheduled and in-house hoist repair services.  We are certified to repair, and offer warranty, on most commercial brands">
...
<body>
  ...
  <section class="ftco-section">
    <div class="container">
      <h1 class="mb-4">Hoist Repair Services</h1>
      <div class="row">
        <div class="col-md-6 ftco-animate">
          <p>Miami Scaffold Rental offers highly-trained technicians to help diagnose and repair your hoist. We offer on-call, scheduled and in-house hoist repair services. Also, emergency repairs when needed. Our goal is to get you back on the job, and running, as soon as possible. We are certified to repair, and offer warranty, on most commercial brands, including <a href="https://www.bisoh.co.jp/en/" target="_blank">BISOMAC</a>, <a href="http://powerclimber.com/" target="_blank">Power Climber</a> and <a href="https://skyclimber.com/" target="_blank">Sky Climber</a>. We work only with OEM parts which helps ensure that you are getting the right part for your hoist. Our warranty repair center is in Medley, FL.</p>
          <h5>Call us at <a href="tel:+13055308090">305-530-8090</a> to schedule a repair.</h5>
        </div>
        <div class="col-md-6 ftco-animate">
          <div class="p-4 bg-light">
            <div class="desc">
              <p>Key services we offer include:</p>
              <ul>
