    <footer class="ftco-footer ftco-no-mb">
      <div class="container">
      <div class="row mb-2">
          <div class="col-12 col-md-6 my-2">
            <div class="ftco-footer-widget d-flex justify-content-center justify-content-sm-start flex-wrap">
              ...
              <a href="https://www.saiaonline.org/" target="_blank" class="px-2 align-self-end"><img style="max-height: 70px;margin-left: -5px;" src="images/saia-logo-white.png"></a>
            </div>
          </div>
          <div class="col-12 col-md-6 my-2">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> Miami Scaffold Rental. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
  ...
  <!-- loader -->
  <div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px"><circle class="path-bg" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke="#eeeeee"/><circle class="path" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke-miterlimit="10" stroke="#64AAE0"/></svg></div>
