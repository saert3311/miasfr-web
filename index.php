...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="/">
        <picture>
          <source media="(max-width:576px), (pointer:coarse) and (min-width:640px)" srcset="images/msr_mobile_w.webp"><img class="erlogo" src="images/msr_logo_bw.webp" alt="Miami Scaffolding Rental Service" width="180" height="90">
        </picture>
      </a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav nav ml-auto">
          ...
          <li class="nav-item cta"><a href="tel:+13055308090" class="external nav-link nav-link-callus">
  ...
  <section class="ftco-counter img pb-5 pt-5 bg-light" id="section-counter" data-section="about">
    <div class="container">
  ...
  <script type='application/ld+json'>
    {
      ...
      "contactPoint": {
        ...
        "telephone": "+13057901410"
      }
    }
  </script>
  <div class="mobile-call"><a href="tel:+13057901410" aria-label="Call us"><button type="button" class="btn btn-primary" aria-label="Call us">
